...
export default function Topbar({
  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-line bg-card px-4 py-3.5 sm:px-6">
      ...
      {/* Module-level navigation now lives only in the Sidebar and the
          dashboard home's "All modules" grid; breadcrumbs (see
          Breadcrumbs.tsx) already show where the current page sits in the
          module hierarchy, so a second, parallel module switcher up here
