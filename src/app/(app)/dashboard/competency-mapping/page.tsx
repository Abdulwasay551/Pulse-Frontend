  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-ink">Competency & Skills Mapping</h1>
          <p className="mt-1 text-sm text-ink-soft">Map skills against role expectations, per employee.</p>
        </div>
        <button
          onClick={openCreate}
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-4">
          {grouped.map(({ employee, ratings: empRatings }) => (
